                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="center" width="60">Hình</td>                            
                            <td class="left">Tên</td>
                            <td class="center" width="110">Tình trạng</td>
                            <td class="center" width="110">Hiện ở trang chủ</td>
                            <td class="right"  width="130">Thao tác</td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        foreach ($list as $row) {
                            ...
                            $image = PATH_TINTUC_THUMB . '/'.$row['avatar'];
                            $active = $row['active'];
                            $img_active = $active == 1 ? STATUS_1 : STATUS_0;
                            ?>
                            <tr>
                                ...
                                <td class="center"><a href="<?= $task_edit; ?>/<?= $id; ?>" title="Edit"><img src="<?= $image; ?>" width="60" border="0"/></a></div>                                
                                <td class="left">
                                    <a href="<?= $task_edit; ?>/<?= $id; ?>">
                                        <strong>
                                            <?= $title; ?>
                                ...
                                <td class="center"><img id="status" status="<?= $active; ?>" onclick="changeStatus(this, '<?= $id; ?>', 'active');" src="<?= $img_active; ?>" /></td>
