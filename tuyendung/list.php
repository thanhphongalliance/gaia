                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="center" width="70">Cho sinh viên</td>
                    ...
                    <tbody>
                        ...
                        foreach ($list as $row) {
                            ...
                            $img_for_student = $for_student == 1 ? STATUS_1 : STATUS_0;
                            ...
                            <tr>
                                ...
                                <td class="center"><img id="status" status="<?= $for_student; ?>" onclick="changeStatus(this, '<?= $id; ?>', 'for_student');" src="<?= $img_for_student; ?>" /></td>
