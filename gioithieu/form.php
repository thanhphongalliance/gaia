                    ...
                    <div id="language1">
                        <table class="form">                            
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="meta_title_vn" value="<?= $meta_title_vn; ?>" size="50" />
                                </td>
                            </tr>
                            <tr>
                                <td>Hình đại diện:</td>
                                <td>
                                    <input type="hidden" name="image" value="<?= $image; ?>" size="70" id="hiddenGioithieu">
                                    <div id="uploadGioithieu"><img src="<?= $image; ?>" id="img_gioithieu" style="max-width: 100px;"/></div>
                    ...
                    <div id="language1">
                        <table class="form">                            
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="meta_title_en" value="<?= $meta_title_en; ?>" size="50" />
                                </td>
                            </tr>
                            <tr>
                                <td>Tóm tắt: </td>
