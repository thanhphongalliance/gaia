...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="right"></div>
    <div class="heading">
      <h1 style="background-image: url('access/image/review.png');"> <a href="<?= $task_list; ?>">
        <?= $title_header; ?>
        (Total:
        <?= $total_rows; ?>
        )</a></h1>
    ...
    <div class="content">
      ...
      <form name="LISTFORM" id="LISTFORM" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
        <table class="list">
          <thead>
            <tr>
              <td width="1" style="text-align: center;"><input onclick="javascript: selectAll(this.checked);" type="checkbox" name="checkall"/></td>
              <td class="center" width="50">Vị trí</td>
              <td class="left">Tên</td>
              <td class="left">Ảnh</td>
              <td class="center" width="100">Tình trạng</td>
              <td class="right"  width="130">Action</td>
            </tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="center"><input type="text" name="ordering[<?= $id; ?>]" value="<?= $ordering; ?>" size="30"/></td>
              <td class="left"><a href="<?= $task_edit; ?>/<?= $id; ?>" title="<?=$title;?>">
                <?=$title;?>
                </a></td>
              <td class="left"><a href="<?= $task_edit; ?>/<?= $id; ?>"><img src="<?= PATH_SLIDER_THUMB."/".$image ?>" width="50"/></a></td>
