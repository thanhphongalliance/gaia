            ...
            <form name="LISTFORM" id="LISTFORM" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">   
                <table class="list">
                    <table class="list">
                        ...
                        <ul>
                            <?php
                            $parent = $this->category->display(0);
                            foreach ($parent as $row) {
                                $id = $row['id'];
                                $title = $row['title'];
                                $ordering = $row['ordering'];
                                $childs = $this->category->display($id);
                                ?>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            foreach ($childs as $chil) {
                                                ...
                                                $grandchild = $this->category->display($chil['id']);
                                                ?>
                                                <li>
                                                    -----<input type="checkbox" name="del[]" value="<?= $chil['id']; ?>"/>
                                                    <input type="text" name="ordering[<?= $chil['id']; ?>]" value="<?= $chil['ordering']; ?>" size="50"/>
                                                    <a class="clearfix" href="<?= $task_edit; ?>/<?= $chil['id']; ?>"><img height="20" src="<?= $image; ?>"/><?= $chil['title']; ?>
                                                        <ul>
                                                            <?php foreach ($grandchild as $grand) { ?>
                                                                <li>
                                                                    ...
                                                                    <a href="<?= $task_edit; ?>/<?= $grand['id']; ?>"><?= $grand['title']; ?></a>
                                                                </li>
                                                            <?php } ?>
                                                        </ul>
                                                    </a>                                                   
