    ...
    <div class="box">
        ...
        <div class="heading">
            ...
            <div class="buttons" style="float:right;">
                <button onclick="return Question_Update();">Update</button>
                <button onclick="return Question_Delete_All();">Del</button>                
                <a href="<?= $task_add; ?>"><button>Add New</button></a>
            </div>
                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="center" width=5%;">Status</td>
                            <td class="right"  width="9%;">Action</td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        foreach ($list as $row) {
                            ...
                            <tr>
                                ...
                                <td class="left"><a href="<?= $task_edit; ?>/<?= $id; ?>" title="Edit"><?= $name; ?></a></td>
    ...
    function changeStatus(this_,id,field){
        ...
        $.ajax({
            ...
            success: function(data) {    
                ...
                if(data==1) $(this_).attr("src",'<?=STATUS_1;?>');
                else if(data==0) $(this_).attr("src",'<?=STATUS_0;?>');
