                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="center" width="100">Hình đại diện</td>   
                            <td class="center">Hình chi tiết</td>   
                    ...
                    <tbody>
                        ...
                        foreach ($list as $row) {
                            ...
                            $image = base_url('dataweb/albums/thumb/'.$row['avatar']);
                            $images = $this->product->getImages($row['id']);
                            ?>
                            <tr>
                                ...
                                <td class="center"><a href="<?= $task_edit; ?>/<?= $id; ?>" title="Edit"><img src="<?= $image; ?>" width="50" border="0"/></a></div>                                
                                <td>
                                <?php foreach($images as $image) : ?>
                                <img src="<?=base_url('dataweb/albums/thumb/'.$image['image'])?>" width="50">
                                <?php endforeach; ?>
                                </td>
